...
<body>
<?php include("pap.php"); ?>
<div style="background: white; width: 500px; height: 510px; margin: auto; border-radius: 5px; border-color: black; border: 4px;">
	<form method="post" action="formulaire.php">
		<fieldset style="height: 475px; border-radius: 5px; border-color: black; font-size: 25px;">
			<legend>S'inscrire</legend>
			<div>
				<label for="nom" style="margin-right: 38px;"> Nom :</label>
				<input type="text"name="nom" minlength="2" max="25" required style="width: 300px; height: 30px;margin-bottom: 15px;">
			</div>
			<div>
				<label for="prenom">Prénoms :</label>
				<input type="text" name="prenom" minlength="2" max="30" required style="margin-bottom: 15px;width: 300px; height: 30px;">
			</div>
			<div>
				<label for="mail" style="margin-right: 21px;">E-mail :</label>
				<input type="text" name="mail" style="width: 300px; height: 30px; margin-bottom: 15px;" required>
			</div>
			<div>
				<label for="age" style="margin-right: 45px;">Age :</label>
				<input type="number" name="age" min="8" max="100" required style="width: 300px; height: 30px;margin-bottom: 15px;">
			</div>
			<div>
				<label for="pays" style="margin-right: 40px;">Pays :</label>
					<select style="width: 50; height: 35px">
			...
			<div>
				...
				<input type="password" name="password" minlength="8" required style="width: 300px; height: 30px; margin-right: 50px; padding-right: 50px;">
			</div>
			<div style="margin: auto; margin-top: 5px;">
				<input type="submit" name="submit" value="Envoyer" style="margin: auto;background-color: white;
				    color: #53af57;
				    border: 1px solid #53af57;     background-color: #53af57;
    color: white;
    padding: 14px 20px;
    margin: 8px 0;
    border: none;
